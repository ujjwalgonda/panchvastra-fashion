...
const ProductItem = () => {
 const context = useContext(MyContext);
  ...
  return (
    <div className="productItem shadow-lg rounded-md px-1 overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center">
...
<img
      ...
      <div className="info p-3 py-5 px-8 w-[75%]">
        ...
        <p className="text-[14px] mb-3">Paired with a matching dupatta and bottoms, the set creates a complete look that’s effortlessly chic.Whether you're dancing at a sangeet or attending a family celebration, this outfit promises to make a statement.</p>

        <Rating name="size-small" defaultValue={2} size="small" readOnly />

        <div className="flex items-center gap-3">
          <span className="price text-gray-700 text-[13px] font-[600]">₹5995</span>
          <span className="oldPrice line-through text-gray-500 text-[13px] font-[500]">₹5995</span>
          <span className="discount text-green-600 text-[13px] font-[700]">21% OFF</span>
        </div>
